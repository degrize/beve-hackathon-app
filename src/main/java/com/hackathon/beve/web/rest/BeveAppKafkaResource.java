...
@RestController
@RequestMapping("/api/beve-app-kafka")
public class BeveAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BeveAppKafkaResource.class);
    ...
    public BeveAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
