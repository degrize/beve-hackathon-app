...
import com.hackathon.beve.security.*;
import com.hackathon.beve.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/createur-africains/liste").permitAll()
            .antMatchers("/api/categorie-createurs/liste").permitAll()
